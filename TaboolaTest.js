...
//get user location
const locationData = JSON.parse(GetData('http://api.ipstack.com/91.164.43.8?access_key=964f49e09150dc34b415565677b4c4f2'));
...
function changeHeaderLanguage(location) {
  if(location === 'US') {
